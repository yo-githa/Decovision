...
def logout():
    ...
    return redirect(url_for('index'))
API_KEY="sk-Ni9AeHXDtj9gk4auRcQa89aqRfqAbMZPSDrG0ONOE8iJDieG"
...
def redefine():
    if request.method == 'POST':
        ...
        full_prompt = f"{prompt}, {room_type} styled as {style}, with {color_palette} tones and {furniture_type} furniture"
        ...
        if response.status_code == 200:
            ...
            return render_template("define.html", image_url="/static/output_image.png")
        else:
